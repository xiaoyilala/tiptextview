...
public class ImageUtils {
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return bitmap == null ? null : new BitmapDrawable(ApplicationUtils.getApplication().getResources(), bitmap);
    }
    ...
    public static Bitmap getBitmap(final String filePath) {
        if (UtilsManager.isSpace(filePath)) {
            return null;
        }
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId,
                                   ...
                                   final int maxHeight) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        final Resources resources = ApplicationUtils.getApplication().getResources();
        options.inJustDecodeBounds = true;
    ...
    public static Bitmap renderScriptBlur(final Bitmap src,
        ...
        Bitmap ret = recycle ? src : src.copy(src.getConfig(), true);
        try {
            rs = RenderScript.create(ApplicationUtils.getApplication());
    ...
    public static boolean save(final Bitmap src,
        ...
        return save(src, UtilsManager.getFileByPath(filePath), format, false);
    }
    ...
    public static boolean save(final Bitmap src,
                               ...
                               final Bitmap.CompressFormat format,
                               final boolean recycle) {
        return save(src, UtilsManager.getFileByPath(filePath), format, recycle);
    }
    ...
    public static boolean save(final Bitmap src,
                               ...
                               final Bitmap.CompressFormat format,
                               final boolean recycle) {
        if (isEmptyBitmap(src) || !UtilsManager.createFileByDeleteOldFile(file)) {
    ...
    public static ImageType getImageType(final String filePath) {
        return getImageType(UtilsManager.getFileByPath(filePath));
    }
    ...
    private static ImageType getImageType(final byte[] bytes) {
        String type = UtilsManager.bytes2HexString(bytes).toUpperCase();
    ...
    public static int[] getSize(String filePath) {
        return getSize(UtilsManager.getFileByPath(filePath));
    }
