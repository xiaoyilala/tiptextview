...
public class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) ApplicationUtils.getApplication().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(ApplicationUtils.getApplication().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) ApplicationUtils.getApplication().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) ApplicationUtils.getApplication()
    ...
    public static boolean isMainProcess() {
        return ApplicationUtils.getApplication().getPackageName().equals(getCurrentProcessName());
    }
