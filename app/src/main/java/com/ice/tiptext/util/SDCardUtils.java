...
public class SDCardUtils {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager sm = (StorageManager) ApplicationUtils.getApplication().getSystemService(Context.STORAGE_SERVICE);
        if (sm == null) {
            return paths;
        }
    ...
    public static long getExternalTotalSize() {
        return UtilsManager.getFsTotalSize(getSDCardPathByEnvironment());
    }
    ...
    public static long getExternalAvailableSize() {
        return UtilsManager.getFsAvailableSize(getSDCardPathByEnvironment());
    }
    ...
    public static long getInternalTotalSize() {
        return UtilsManager.getFsTotalSize(Environment.getDataDirectory().getAbsolutePath());
    }
    ...
    public static long getInternalAvailableSize() {
        return UtilsManager.getFsAvailableSize(Environment.getDataDirectory().getAbsolutePath());
    }
    ...
    public static class SDCardInfo {
        ...
        SDCardInfo(String path, String state, boolean isRemovable) {
            ...
            this.totalSize = UtilsManager.getFsTotalSize(path);
            this.availableSize = UtilsManager.getFsAvailableSize(path);
        }
        ...
        public String toString() {
            return "SDCardInfo {" +
                    ...
                    ", totalSize = " + Formatter.formatFileSize(ApplicationUtils.getApplication(), totalSize) +
                    ", availableSize = " + Formatter.formatFileSize(ApplicationUtils.getApplication(), availableSize) +
                    '}';
        }
    }
}
