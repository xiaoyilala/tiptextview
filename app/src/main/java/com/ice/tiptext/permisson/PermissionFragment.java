...
public final class PermissionFragment extends Fragment implements Runnable {
    ...
    private final static SparseArray<IOnPermissionCallback> sContainer = new SparseArray<>();
    ...
    public static PermissionFragment newInstant(ArrayList<String> permissions) {
        ...
        do {
            requestCode = new SecureRandom().nextInt(65535);//Studio编译的APK请求码必须小于65536
     ...
     * 准备请求
     */
    public void prepareRequest(Activity activity, IOnPermissionCallback call) {
        //判断activity是否存在
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        IOnPermissionCallback call = sContainer.get(requestCode);
